    ...
    <br />
      ...
      <div id="Education" className="h-120 mt-15 mb-5 ">
        ...
        <div className=" ml-13 flex flex-row justify-around w-6xl h-100 mt-5 ">
          <div className="flex justify-around flex-col w-150 h-90 mt-5">
            <div className="  w-95 rounded-2xl bg-amber-100 shadow-[12px_13px_35px_-2px_rgba(0,_0,_0,_0.15)] hover:shadow-[12px_13px_35px_-1px_#e0cf99]">
              <div className="text-xl text-blackgap-7 ml-27 mt-5 ">
                Post Graduation
              </div>
            ...
            <div className=" mt-2 w-95 rounded-2xl bg-amber-100 shadow-[12px_13px_35px_-2px_rgba(0,_0,_0,_0.15)] hover:shadow-[12px_13px_35px_-1px_#e0cf99]">
              <div className="text-xl text-blackgap-7 ml-27 mt-5  ">
                Under Graduation
              </div>
              <div className="ml-10  mb-5 pt-2">
            ...
            <div className="text-xl text-blackgap-7 ml-15 mt-5">
              Higher Secondary Education
            </div>
            <div className="ml-10  mb-5 pt-2">
              {" "}
              Maa Laxmi Bai Public School Thikri 2019-2020{" "}
              </div>
            </div>
          </div>
